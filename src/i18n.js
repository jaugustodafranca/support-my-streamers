...
const MESSAGES = {
  pt: {
    ...
    audio_label: 'Áudio',
    audio_hint:
      '"Mudo" silencia o player de verdade — sem truque pra contornar a contagem da Twitch.',
    audio_muted: 'Mudo',
    audio_on: 'Com som',
    save: 'Salvar',
    saved: 'Salvo!',
  ...
  en: {
    ...
    audio_label: 'Audio',
    audio_hint: '"Muted" mutes the actual player — no trick to game Twitch\'s view count.',
    audio_muted: 'Muted',
    audio_on: 'Sound on',
    save: 'Save',
    saved: 'Saved!',
